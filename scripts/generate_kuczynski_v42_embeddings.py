#!/usr/bin/env python3
"""Generate embeddings for the Kuczynski v42 Database (including new Chomsky positions)"""
...
def generate_embeddings():
    ...
    old_embeddings = glob.glob('data/kuczynski_v42_embeddings_*.pkl')
    if old_embeddings:
    ...
    part_size = 1000
    chunk_size = 250
    base_path = 'data/kuczynski_v42_embeddings'
